...
<div x-data="{ showModal: false, editItem: null, openEdit(item){ this.editItem = item; this.showModal = true }, openAdd(){ this.editItem = null; this.showModal = true } }">
    ...
    <div class="card overflow-hidden">
        <table class="data-table w-full">
            <thead><tr><th>Nama</th><th>Telepon</th><th>Email</th><th>Poin</th><th class="text-right">Aksi</th></tr></thead>
            <tbody>
                ...
                @empty
                <tr><td colspan="5" class="text-center text-slate-400 py-8">Belum ada pelanggan.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
